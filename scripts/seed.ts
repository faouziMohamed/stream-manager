...
async function seed() {
  ...
  await db
    ...
    .values([
      { promotionId: promoTripleId, serviceId: netflixId },
      { promotionId: promoTripleId, serviceId: shahidId },
      { promotionId: promoTripleId, serviceId: primeId },
      { promotionId: promoDuoId, serviceId: netflixId },
      { promotionId: promoDuoId, serviceId: primeId },
    ])
    .onConflictDoNothing();
