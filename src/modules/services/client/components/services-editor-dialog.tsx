...
export function ServiceDialog({ open, service, onOpenChange, onSubmit }: ServiceDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <FormGroup label="Description" hint="Description visible sur la page d'accueil">
              ...
              <Label className="flex items-center gap-1.5 text-sm font-medium">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top">
                    <p>Les services masqués restent accessibles via lien direct</p>
                  </TooltipContent>
                </Tooltip>
              </Label>
