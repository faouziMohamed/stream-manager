  ...
  if (logoUrl) {
    ...
    return (
      <Image
        ...
        width={px}
        height={px}
        className={`${dim[size]} object-cover shrink-0 border border-border/50`}
      />
    );
  }
  return (
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* ── Hero ──────────────────────────────────────────────────────── */}
      <section className="relative overflow-hidden border-b bg-linear-to-b from-primary/5 to-transparent">
      ...
      <div className="max-w-5xl mx-auto px-4 py-14 space-y-16" id="offres">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Plusieurs services, un seul prix
                </p>
              </div>
            </div>
              ...
              {promos.map((promo) => (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <Badge className="shrink-0 bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/25 hover:bg-amber-500/15 text-xs">
                      Pack
                    </Badge>
                  </div>
                  {promo.expiresAt && (
        ...
        {/* ── CTA ───────────────────────────────────────────────────── */}
        {hasContent && (
          <section className="rounded-2xl bg-primary text-primary-foreground p-8 sm:p-12 text-center space-y-4">
