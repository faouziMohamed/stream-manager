...
import { NotificationsEditor } from '@/modules/settings/client/components/notifications-editor';
...
export default async function NotificationsSettingsPage() {
  ...
  const settings: NotificationSettingDto[] = Object.entries(NOTIFICATION_LABELS).map(
    ([event, label]) => ({
      event,
      label,
