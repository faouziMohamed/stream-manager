...
import { ActiveServiceCard, DeletedServiceCard } from "./services-service-card";
import type { ServiceDto } from "@/lib/graphql/operations/services.operations";
import type { ServiceForm } from "./services-service-dialog";
        ...
        <TabsContent value="active" className="space-y-2 mt-4">
          {services.length === 0 ? (
            <InfoCallout variant="info" title="Bienvenue ! Commencez ici">
              Créez votre premier service (Netflix, Disney+, etc.). Ajoutez
              ensuite des formules tarifaires (durée, prix) depuis l&apos;onglet
              &quot;Formules&quot; une fois le service créé. Les abonnements
              lieront vos clients aux services.
            </InfoCallout>
          ) : (
