...
export function AccountsEditor({
  ...
  // Forms
  const accountForm = useForm<AccountFormInput>({
  ...
  const openAssignProfile = (
    accountId: string,
    profile: StreamingProfileDto,
  ) => {
    assignForm.reset({
      subscriptionId: profile.assignment?.subscriptionId ?? "",
    });
    setAssignDialog({
      open: true,
      accountId,
  ...
  const openAssignAccount = (acc: StreamingAccountDto) => {
    assignForm.reset({
      subscriptionId: acc.accountAssignment?.subscriptionId ?? "",
    });
    setAssignDialog({
      open: true,
      accountId: acc.id,
    ...
    <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="flex gap-1 shrink-0">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setDeleteTarget({ type: "account", id: acc.id })
                        }
                      >
                                ...
                                >
                                  ...
                                  {sub ? (
                                    ...
                                    <Button
                                      ...
                                      className="h-6 text-xs px-2"
                                      onClick={() =>
                                        openAssignProfile(acc.id, profile)
                                      }
                                    >
                                      Assigner
                                    </Button>
                                  ...
                                  <div className="flex gap-1 shrink-0">
                                    <Button
                                      ...
                                      className="h-6 w-6"
                                      onClick={() =>
                                        openEditProfile(acc.id, profile)
                                      }
                                    >
      ...
      >
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle>
              {assignDialog.title ?? "Assigner à un abonné"}
            </DialogTitle>
          </DialogHeader>
          <form
          ...
          >
            <div className="space-y-1.5">
              ...
              >
                <SelectTrigger
                  error={assignForm.formState.errors.subscriptionId?.message}
                >
