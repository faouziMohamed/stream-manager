...
export const GET_CLOUDINARY_SETTINGS = /* GraphQL */ `
    query GetCloudinarySettings {
        cloudinarySettings {
            cloudName apiKey uploadPreset folder hasApiSecret
        }
    }
`;
...
export const REPLACE_CLOUDINARY_IMAGE = /* GraphQL */ `
    mutation ReplaceCloudinaryImage($oldPublicId: String!, $base64: String!, $filename: String) {
        replaceCloudinaryImage(oldPublicId: $oldPublicId, base64: $base64, filename: $filename) {
            success message publicId url
        }
    }
`;
...
export const GET_CLOUDINARY_MEDIA = /* GraphQL */ `
    query GetCloudinaryMedia($folder: String) {
        cloudinaryMedia(folder: $folder) {
            publicId url format width height bytes folder createdAt
        }
    }
`;
